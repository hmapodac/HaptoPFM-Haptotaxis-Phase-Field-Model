...
PhaseModel1.py file.  This is the main code that is called in the csh bash file
...
# The following executable calls the PhaseModel1 code to run in a parallel manner.
# The number of parallel processes can be modified for the computational load desired.
if __name__=='__main__':
    with concurrent.futures.ProcessPoolExecutor(max_workers=(8)) as executor:
        output = [executor.submit(PhaseModel1.phasemodel,param,inputphi[i].reshape(-1),i)\
